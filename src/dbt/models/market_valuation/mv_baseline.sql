...
select
    ...
    id as player_id,
    position,
    player_pts_avg_this_season as avg_points_this_season,
    matches_this_season as games_this_season,
    player_pts_avg_last_season as avg_points_last_season,
    matches_last_season as games_last_season,
    position_pts_avg_last_season as position_avg_last_season,
